/*
 * mt8168-afe-controls.c  --  Mediatek 8168 audio controls
 *
...
static int mt8168_afe_cm_bypass_put(struct snd_kcontrol *kcontrol,
				    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_platform *plat = snd_soc_kcontrol_platform(kcontrol);
	struct mtk_base_afe *afe = snd_soc_platform_get_drvdata(plat);
...
static int mt8168_afe_singen_enable_put(struct snd_kcontrol *kcontrol,
					struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_platform *plat = snd_soc_kcontrol_platform(kcontrol);
	struct mtk_base_afe *afe = snd_soc_platform_get_drvdata(plat);
	...
	if (ucontrol->value.integer.value[0]) {
		mt8168_afe_enable_top_cg(afe, MT8168_TOP_CG_TML);
		...
		mt8168_afe_disable_top_cg(afe, MT8168_TOP_CG_TML);
	}
...
static int mt8168_afe_sinegen_loopback_mode_get(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_platform *plat = snd_soc_kcontrol_platform(kcontrol);
	struct mtk_base_afe *afe = snd_soc_platform_get_drvdata(plat);
...
static int mt8168_afe_sinegen_loopback_mode_put(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_platform *plat = snd_soc_kcontrol_platform(kcontrol);
	struct mtk_base_afe *afe = snd_soc_platform_get_drvdata(plat);
...
static int mt8168_afe_sinegen_timing_get(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_platform *plat = snd_soc_kcontrol_platform(kcontrol);
	struct mtk_base_afe *afe = snd_soc_platform_get_drvdata(plat);
...
static int mt8168_afe_sinegen_timing_put(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_platform *plat = snd_soc_kcontrol_platform(kcontrol);
	struct mtk_base_afe *afe = snd_soc_platform_get_drvdata(plat);
...
static int mt8168_afe_ap_loopback_get(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
...
static int mt8168_afe_ap_loopback_put(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_platform *platform = snd_soc_kcontrol_platform(kcontrol);
	struct mtk_base_afe *afe = snd_soc_platform_get_drvdata(platform);
...
static const struct snd_kcontrol_new mt8168_afe_controls[] = {
	SOC_SINGLE_BOOL_EXT("CM1_Bypass_Switch",
			    0,
			    mt8168_afe_cm_bypass_get,
			    mt8168_afe_cm_bypass_put),
	...
	SOC_SINGLE_BOOL_EXT("Audio_SineGen_Enable",
			    0,
			    mt8168_afe_singen_enable_get,
			    mt8168_afe_singen_enable_put),
	SOC_ENUM_EXT("Audio_SideGen_Switch",
		     mt8168_afe_soc_enums[CTRL_SINEGEN_LOOPBACK_MODE],
		     mt8168_afe_sinegen_loopback_mode_get,
		     mt8168_afe_sinegen_loopback_mode_put),
	SOC_ENUM_EXT("Audio_SideGen_SampleRate",
		     mt8168_afe_soc_enums[CTRL_SINEGEN_TIMING],
		     mt8168_afe_sinegen_timing_get,
		     mt8168_afe_sinegen_timing_put),
...
{
	return snd_soc_add_platform_controls(platform, mt8168_afe_controls,
					     ARRAY_SIZE(mt8168_afe_controls));
}
