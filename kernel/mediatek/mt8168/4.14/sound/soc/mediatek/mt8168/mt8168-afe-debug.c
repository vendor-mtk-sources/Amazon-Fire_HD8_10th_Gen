/*
 * mt8168-afe-debug.c  --  Mediatek 8168 audio debugfs
 *
...
static ssize_t mt8168_afe_dump_registers(char __user *user_buf,
					 size_t count,
					 loff_t *pos,
...
static ssize_t mt8168_afe_read_file(struct file *file,
				    ...
				    loff_t *pos)
{
	...
	ret = mt8168_afe_dump_registers(user_buf, count, pos, afe,
					afe_dump_regs,
...
static ssize_t mt8168_afe_write_file(struct file *file,
...
static ssize_t mt8168_afe_memif_read_file(struct file *file,
					  char __user *user_buf,
					  size_t count,
					  loff_t *pos)
{
...
static ssize_t mt8168_afe_irq_read_file(struct file *file,
					char __user *user_buf,
					size_t count,
					loff_t *pos)
{
...
static ssize_t mt8168_afe_conn_read_file(struct file *file,
					 char __user *user_buf,
					 size_t count,
					 loff_t *pos)
{
...
static ssize_t mt8168_afe_dbg_read_file(struct file *file,
					char __user *user_buf,
					size_t count,
					loff_t *pos)
{
...
static const struct file_operations mt8168_afe_fops = {
	.open = simple_open,
	.read = mt8168_afe_read_file,
	.write = mt8168_afe_write_file,
	.llseek = default_llseek,
};

static const struct file_operations mt8168_afe_memif_fops = {
	.open = simple_open,
	.read = mt8168_afe_memif_read_file,
	.llseek = default_llseek,
};

static const struct file_operations mt8168_afe_irq_fops = {
	.open = simple_open,
	.read = mt8168_afe_irq_read_file,
	.llseek = default_llseek,
};

static const struct file_operations mt8168_afe_conn_fops = {
	.open = simple_open,
	.read = mt8168_afe_conn_read_file,
	.llseek = default_llseek,
};

static const struct file_operations mt8168_afe_dbg_fops = {
	.open = simple_open,
	.read = mt8168_afe_dbg_read_file,
	.llseek = default_llseek,
};

static const
struct mt8168_afe_debug_fs afe_debug_fs[MT8168_AFE_DEBUGFS_NUM] = {
	{"mtksocaudio", &mt8168_afe_fops},
	{"mtksocaudiomemif", &mt8168_afe_memif_fops},
	{"mtksocaudioirq", &mt8168_afe_irq_fops},
	{"mtksocaudioconn", &mt8168_afe_conn_fops},
	{"mtksocaudiodbg", &mt8168_afe_dbg_fops},
};
...
void mt8168_afe_cleanup_debugfs(struct mtk_base_afe *afe)
{
	...
	for (i = 0; i < MT8168_AFE_DEBUGFS_NUM; i++)
