...
ifneq ($(strip $(TARGET_NO_KERNEL)),true)
  ...
  ifeq ($(wildcard $(TARGET_PREBUILT_KERNEL)),)
    ...
    KERNEL_MAKE_OPTION := O=$(KERNEL_ROOT_DIR)/$(KERNEL_OUT) ARCH=$(KERNEL_TARGET_ARCH) CROSS_COMPILE=$(TARGET_KERNEL_CROSS_COMPILE) $(TARGET_KERNEL_CLANG_COMPILE) ROOTDIR=$(KERNEL_ROOT_DIR) $(if $(strip $(SHOW_COMMANDS)),V=1)
