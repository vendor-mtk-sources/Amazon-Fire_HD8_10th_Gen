...
#include "gc2375hmipi_cxt_rear_Sensor.h"

/**************** Modify Following Strings for Debug ****************/
#define PFX "gc2375h_cxt_rear_camera_sensor"
...
kal_bool GC2375H_CXT_REAR_DuringTestPattern = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC2375HMIPI_CXT_REAR_SENSOR_ID,
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	GC2375H_CXT_REAR_DuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
...
UINT32 GC2375HMIPI_CXT_REAR_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT
					**pfFunc)
{
