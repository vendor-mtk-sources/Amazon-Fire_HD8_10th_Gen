...
enum enumTestItem_FT5822 {
	Code_FT5822_ENTER_FACTORY_MODE,/* necessary test items */
	Code_FT5822_DOWNLOAD,/* necessary test item */
	Code_FT5822_UPGRADE,/* necessary test item */
	...
	Code_FT5822_WRITE_CONFIG,/* necessary test item */
