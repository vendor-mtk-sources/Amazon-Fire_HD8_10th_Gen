...
#define CONSYS_IF_DRIVING_REG_BASE		0x11C50000

#define CONSYS_IF_DRIVING_BT_SPI_OFFSET		0x000000A0
#define CONSYS_IF_DRIVING_BT_SPI_MASK		0x00FFFFFF
#define CONSYS_IF_DRIVING_BT_SPI_4MA_VALUE	0x11000000
#define CONSYS_IF_DRIVING_BT_SPI_16MA_VALUE	0x77000000

#define CONSYS_IF_DRIVING_WIFI_SPI_OFFSET	0x000000B0
#define CONSYS_IF_DRIVING_WIFI_SPI_MASK		0xFFFFF000
#define CONSYS_IF_DRIVING_WIFI_SPI_16MA_VALUE	0x00000777
#endif
